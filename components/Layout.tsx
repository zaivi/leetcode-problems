...
interface LayoutProps {
  ...
  activeView: 'dashboard' | 'explorer' | 'myproblems';
  onViewChange: (view: 'dashboard' | 'explorer' | 'myproblems') => void;
        ...
        <nav className="flex items-center gap-1 bg-dark-900/50 p-1 rounded-lg border border-dark-700">
          <button
            ...
            className={`px-3 py-1.5 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${
              activeView === 'dashboard' ? 'bg-primary-600 text-white shadow-lg' : 'text-slate-400 hover:text-white hover:bg-dark-700'
            }`}
          >
            <BarChart2 size={16} />
            Dashboard
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${
              activeView === 'explorer' ? 'bg-primary-600 text-white shadow-lg' : 'text-slate-400 hover:text-white hover:bg-dark-700'
            }`}
          >
            <Github size={16} />
            Explorer
          ...
          <button
            onClick={() => onViewChange('myproblems')}
            className={`px-3 py-1.5 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${
              activeView === 'myproblems' ? 'bg-primary-600 text-white shadow-lg' : 'text-slate-400 hover:text-white hover:bg-dark-700'
            }`}
          >
            <ListChecks size={16} />
            My Problems
