...
import { Search, Folder, ChevronRight, Loader2, X } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className={`
        ...
        fixed lg:relative
        w-64 h-full 
        border-r border-dark-700 bg-dark-800 
      ...
      `}>
        {/* Mobile Close Button */}
        {onClose && (
          <div className="lg:hidden p-3 border-b border-dark-700 flex items-center justify-between">
            <span className="text-sm font-semibold text-slate-300">Companies</span>
            <button
              onClick={onClose}
